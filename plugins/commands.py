...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('UNMESH', url=f"https://t.me/HoiChoiTvAddaa")
            ]
            ]
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Aritra-01/Ajax-Upstream/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
